...
void loop () {
  ...
  if (programMode) {
    if ( isMaster(readCard) ) { //When in program mode check First If master card scanned again to exit program mode
      ...
      lcd.clear();
      lcd.setCursor(1, 0); 
      lcd.print("Master terbaca");
      lcd.setCursor(1, 1); 
      lcd.print("keluar program");
      delay(1000);
      lcd.clear();
        lcd.setCursor(2, 0); 
    ...
    if ( isMaster(readCard)) {    // If scanned card's ID matches Master Card's ID - enter program mode
      ...
      Serial.println(F("-----------------------------"));
      lcd.setCursor(0, 1); 
      lcd.print(count);lcd.print(" kartu disimpan");
      ...
      if ( findID(readCard) ) { // If not, see if the card is in the EEPROM
        ...
        granted(10);         // Open the door lock for 300 ms
        lcd.clear();
        lcd.setCursor(2, 0); 
        lcd.print("tempel kartu");
